...
**windows:**
- move `forage-windows-amd64.exe` to a folder of your choice and rename it `forage.exe`
- add that folder to your PATH:
  1. press `Win+R`, type `sysdm.cpl`, and hit enter
  2. go to **Advanced** → **Environment Variables**
  3. under **System variables**, find and select `Path`, then click **Edit**
  4. click **New** and paste the folder path (e.g. `C:\tools`)
  5. click OK on all dialogs, then restart your terminal
- alternatively, run it directly: `.\forage-windows-amd64.exe "spotify-url"`
